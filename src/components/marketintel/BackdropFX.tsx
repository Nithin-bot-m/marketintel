...
export default function BackdropFX() {
  const { theme, scanlines } = useMarketTheme();

  return (
    <>
      {/* Permanent CRT Scanlines Filter Overlay */}
      <div
        aria-hidden
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="dot-grid absolute inset-0 opacity-[0.25] [mask-image:radial-gradient(ellipse_at_50%_0%,black_5%,transparent_60%)]" />
